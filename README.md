...
Источник таблицы: слайды защиты. 

---

## Проверяемые гипотезы (интерпретируемость)

1) **Тематическая близость к недавним товарам:** рекомендации SASRec тематически ближе к последним товарам в истории пользователя.  
2) **Важность “дальней” истории:** элементы истории старше последних ~15 конверсий слабо влияют на рекомендации обученной модели (в рамках данного датасета/настроек).
